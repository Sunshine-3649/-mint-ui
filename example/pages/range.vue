<template>
  <div class="page-range">
    ...
    <mt-cell v-for="(item, i) in cells1" :key="i" :title="item.title" :label="'value:' + item.value">
    ...
    <mt-cell v-for="(item, i) in cells2" :key="i" :title="item.title" :label="'value:' + item.value">
    ...
    <mt-cell v-for="(item, i) in cells3" :key="i" :title="item.title" :label="'value:' + item.value">
